...
def main():
    ...
    test_agents.append(tournament.Agent(tournament.CustomPlayer(score_fn=game_agent.common_moves1, **CUSTOM_ARGS),
                                        "Student CommonMoves 1"))

    test_agents.append(tournament.Agent(tournament.CustomPlayer(score_fn=game_agent.common_moves2, **CUSTOM_ARGS),
                                        "Student CommonMoves 2"))

    test_agents.append(tournament.Agent(tournament.CustomPlayer(score_fn=game_agent.common_moves3, **CUSTOM_ARGS),
                                        "Student CommonMoves 3"))
